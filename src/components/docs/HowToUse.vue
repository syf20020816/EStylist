  ...
  <div class='typora-export os-windows'>
    <div class='typora-export-content'>
      <div id='write' class=''>
        ...
        <p><span>首先，我们来了解一下软件的整体构成，EStylist目前由6个模块构成</span></p>
        ...
        <blockquote>
          <p><span>❗下载下来的文件将存储到EStylist所在的templates目录下</span></p>
          <p><span>❗The downloaded files will be stored in the templates directory where EStylist is located</span></p>
          <p><span>❗上传文件时请不要焦急，为了完整的解析文件程序会等待1.5s左右的时间，请不要手动关闭，程序解析结束会自动关闭</span></p>
          <p><span>❗Please do not be anxious when uploading files. In order to fully parse the file, the program will wait for about 1.5 seconds. Please do not manually close it. The program will automatically close after parsing</span></p>
        </blockquote>
