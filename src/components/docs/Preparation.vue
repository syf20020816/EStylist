<template>
  <div class='typora-export os-windows'>
    <div class='typora-export-content'>
      <div id='write' class=''>
        <h1 id='preparation'><span>Preparation</span></h1>
        <p><span>如果您想要通过EStylist发送模板给他人，那么你就需要开启SMTP服务，例如:</span></p>
        <p><span>If you want to send templates to others through EStylist, you need to enable the SMTP service, such as:</span></p>
        <ul>
          <li><span>腾讯企业邮件（QQ 邮箱）：</span><a href='http://smtp.qq.com'><span>smtp.qq.com</span></a></li>
          <li><span>腾讯企业邮件（企业版 QQ 邮箱）：</span><a href='http://smtp.exmail.qq.com'><span>smtp.exmail.qq.com</span></a></li>
          <li><span>Gmail：</span><a href='http://smtp.gmail.com'><span>smtp.gmail.com</span></a></li>
          <li><span>雅虎邮箱（Yahoo Mail）：</span><a href='http://smtp.mail.yahoo.com'><span>smtp.mail.yahoo.com</span></a></li>
          <li><span>Hotmail/Outlook.com：</span><a href='http://smtp.live.com'><span>smtp.live.com</span></a></li>
          <li><span>新浪邮箱：</span><a href='http://smtp.sina.com.cn'><span>smtp.sina.com.cn</span></a></li>
          <li><span>163 邮箱：</span><a href='http://smtp.163.com'><span>smtp.163.com</span></a></li>
          <li><span>126 邮箱：</span><a href='http://smtp.126.com'><span>smtp.126.com</span></a></li>
          <li><span>搜狐邮箱：</span><a href='http://smtp.sohu.com'><span>smtp.sohu.com</span></a></li>
          <li><span>邮件中国：</span><a href='http://smtp.chinaemail.cn'><span>smtp.chinaemail.cn</span></a></li>
        </ul>
        <p><span>这些是较为常见的 SMTP 服务提供商，你可以根据自己使用的邮箱服务选择相应的 SMTP 服务器地址。请注意，在使用这些 SMTP 服务器发送邮件之前，你可能需要提供正确的端口号、用户名和密码等认证信息。每个 SMTP 服务器提供商可能有不同的配置要求，请确保按照相应的服务提供商文档进行正确的设置。</span></p>
        <p><span>These are common SMTP service providers, and you can choose the corresponding SMTP server address based on the email service you use. Please note that before using these SMTP servers to send emails, you may need to provide the correct authentication information such as port number, username, and password. Each SMTP server provider may have different configuration requirements, please ensure that the correct settings are made according to the corresponding service provider documentation.</span></p>
