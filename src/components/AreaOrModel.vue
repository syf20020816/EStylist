<template>
  <div :class="build('template','base')" style="display: flex;flex-wrap: wrap;">
    <div class="tmptitle" style="width: 100%;font-size:14px;">
      <el-icon>
        <Operation />
      </el-icon>
      {{ getStr(store.settings.language,pagei18n.edit.modelTitle) }}
    </div>
...
import { getStr, pagei18n, AreaModel, defaultAreaModel, JustifyContent, TextAlign, ModelTypes, Direction, FontFamily, ModelItem } from '../core'
